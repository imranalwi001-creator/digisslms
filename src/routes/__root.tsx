...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Digisschool LMS — Digital Islamic Boarding School" },
      { name: "description", content: "Platform pembelajaran digital terpadu untuk santri dan siswa Digital Islamic Boarding School." },
      { name: "author", content: "Digisschool LMS" },
      { property: "og:title", content: "Digisschool LMS — Digital Islamic Boarding School" },
      ...
      { name: "twitter:title", content: "Digisschool LMS — Digital Islamic Boarding School" },
