...
const SUGGESTED_HABITS = [
  { name: "Menonton video materi", description: "20 menit per sesi", color: HABIT_COLORS[0] },
  { name: "Membaca modul", description: "Minimal 10 halaman", color: HABIT_COLORS[1] },
  { name: "Latihan soal", description: "5 soal setiap hari", color: HABIT_COLORS[4] },
  { name: "Catatan refleksi", description: "Rangkum apa yang dipelajari", color: HABIT_COLORS[2] },
];
        ...
        {step === 1 && (
          <div className="text-center animate-fade-up-blur">
            ...
            <div className="mt-6 space-y-4 text-left">
              {[
                { emoji: "☑️", text: "Ketuk untuk menandai pelajaran selesai setiap hari" },
                { emoji: "🔥", text: "Bangun rangkaian hari belajar berturut-turut" },
                { emoji: "📊", text: "Lihat progres belajar Anda tumbuh" },
              ].map(({ emoji, text }, i) => (
                <div
                  key={i}
